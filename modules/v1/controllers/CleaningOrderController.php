...
use app\models\search\CleaningOrderSearch;

class CleaningOrderController extends CoreController
{
    ...
    public function actionUpdate()
    {
        ...
        $model = CoreController::coreFindModelOne(new CleaningOrder(), $params);
